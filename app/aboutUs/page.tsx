    ...
    <motion.div
      ...
      <div className="min-h-screen w-full py-24">
        ...
        <motion.div
          ...
          className="text-3xl sm:text-4xl font-serif text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 sm:gap-12 pt-10 px-6 lg:px-16 xl:px-32">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false }}
            transition={{ duration: 0.8, ease: "easeOut" }} className="w-full md:w-2/5 lg:w-1/4 h-80 sm:h-96 md:h-80 lg:h-96  overflow-hidden shadow-lg flex items-center justify-center">
            <Image
              src={laptopImg}
              alt="Laptop"
          ...
          <div className="w-full md:w-2/3 text-sm xl:text-xl lg:text-lg leading-relaxed">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: false }}
              transition={{ duration: 0.8, ease: "easeOut" }} className="mt-6">
